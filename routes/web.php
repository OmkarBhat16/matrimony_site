...
Route::get('/matrimony', [MatrimonyController::class, 'index'])->name('root.matrimony');
...
Route::get('/profile/{userProfile}', [UserProfileController::class, 'show'])->middleware('auth')->name('profile.show');
...
Route::get("/admin/users", [AdminUserController::class, 'index'])->name('admin.users')->middleware('auth');

Route::post("/users/{user}/approve", [AdminUserController::class, 'approve'])->name("users.approve")->middleware('auth');

Route::view("/admin/settings", "admin.settings")->middleware('auth')->name('admin.settings');
