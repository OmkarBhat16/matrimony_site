<x-layout title="Matrimony">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        @if ($showFilters)
            <form method="GET" action="{{ route('root.matrimony') }}" x-data="{ filtersCollapsed: false }" class="relative z-30 bg-white/95 backdrop-blur rounded-2xl shadow-lg border border-gray-100 mb-8 overflow-visible">
