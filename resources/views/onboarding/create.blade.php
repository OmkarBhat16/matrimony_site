                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <select id="blood_group" name="blood_group"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-pink-500 focus:border-pink-500 bg-white">
                                    <option value="" @selected(old('blood_group') === null || old('blood_group') === '')>Select blood group</option>
                            ...
                            <div>
                                ...
                                <select id="zodiac_sign__Raas" name="zodiac_sign__Raas"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-pink-500 focus:border-pink-500 bg-white">
                                    <option value="" @selected(old('zodiac_sign__Raas') === null || old('zodiac_sign__Raas') === '')>Select zodiac sign</option>
                                    @foreach(\App\Models\UserProfile::RAAS as $raas)
                                        <option value="{{ $raas }}" @selected(old('zodiac_sign__Raas') === $raas)>{{ $raas }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select id="gann" name="gann"
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-pink-500 focus:border-pink-500 bg-white">
                                    <option value="" @selected(old('gann') === null || old('gann') === '')>Select gann</option>
                                    @foreach(\App\Models\UserProfile::GANN as $gann)
                                        <option value="{{ $gann }}" @selected(old('gann') === $gann)>{{ $gann }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
